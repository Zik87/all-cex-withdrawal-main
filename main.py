...
#----second-options----#
amount = [0.40, 0.40]          # минимальная и максимальная сумма
...
class API:
    ...
    # okx API
    okx_apikey = "644f82e1-f4d1-474c-ae4c-5e5a12e0b250"
    okx_apisecret = "ACC5E7725ADDBFE781EC9B5D843ED8C4"
    okx_passphrase = "!Supra19960410"
    # bybit API
